...
| :--- | :--- | :--- |
| **Operating System** | Windows 10/11, macOS 11+, or Linux | Windows 11 / macOS 13+ |
| **CPU** | 4 cores | 8 cores |
...
1. Download **`Run_Analysis.bat`** from this repository and place it in your `EVE_Workspace` folder.
...
> [!TIP]
> A typical WES sample takes **2–6 hours** to process, depending on your hardware. Keep your computer plugged in and prevent it from going to sleep.
...
### ❌ Problem 2: `permission denied` when running Docker
...
### ❌ Problem 3: `is not a valid Windows path` Error
...
### ❌ Problem 4: `SnpEff database not found!` Error
...
### ❌ Problem 5: `No input FASTQ files found` Error
...
### ❌ Problem 6: Reference data download fails or is corrupted
...
### ❌ Problem 7: Memory / RAM Crash (GATK Errors)
...
### ❌ Problem 8: Pipeline runs but the Excel report is empty or missing variants
...
### ❌ Problem 9: Docker says "no space left on device"
